    ...
    return(
        ...
        <div className="banner">  
            ...
            <div className = "buttons">
                <Link to="/LoRaRadioMultiPurposeDevice" id = 'button'><FiArrowLeft size = {20} color = 'black'/></Link>
                <Link to="/" id = 'button'><AiOutlineHome size = {20} color = 'black'/></Link>
                <Link to="/StepperMotorController" id = 'button'><FiArrowRight size = {20} color = 'black'/></Link>
            </div>
        </div>
        <div className="ProjectContainer">
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/SSBimg1.png' alt=''/><figcaption>Bracelet Sketches</figcaption> </figure>
                <figure><img src='/images/SSBimg4.png' alt=''/><figcaption>Design Matrix (TX)</figcaption> </figure>
            </div>
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/SSBimg2.png' alt=''/><figcaption>STM32 + Push Buttons (left), LoRa (right)</figcaption> </figure>
                <figure><img src='/images/SSBimg3.png' alt=''/><figcaption>CAD Model of Bracelet</figcaption> </figure>
