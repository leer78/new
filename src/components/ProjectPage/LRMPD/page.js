    ...
    return(
        ...
        <div className="banner">  
            ...
            <div className = "buttons">
                <Link to="/RPiControlledLEDStrip" id = 'button'><FiArrowLeft size = {20} color = 'black'/></Link>
                <Link to="/" id = 'button'><AiOutlineHome size = {20} color = 'black'/></Link>
                <Link to="/ShockOrStudyBracelet" id = 'button'><FiArrowRight size = {20} color = 'black'/></Link>
            </div>
        </div>
        <div className="ProjectContainer">
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/LRMPDimg1.jpg' alt=''/><figcaption>Nano Setup (RX)</figcaption> </figure>
                <figure><img src='/images/LRMPDimg2.jpg' alt=''/><figcaption>Uno Setup (TX)</figcaption> </figure>
            </div>
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/LRMPDimg3.png' alt=''/><figcaption>Nano Wiring</figcaption> </figure>
                <figure><img src='/images/LRMPDimg4.png' alt=''/><figcaption>Uno Wiring</figcaption> </figure>
