    ...
    return(
        ...
        <div className="banner">  
            ...
            <div className = "buttons">
                <Link to="/page7" id = 'button'><FiArrowLeft size = {20} color = 'black'/></Link>
        ...
        <div className="ProjectContainer">
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/p8img1.png' alt=''/><figcaption>Final Physical Circuit</figcaption> </figure>
                <figure><img src='/images/p8img2.jpg' alt=''/><figcaption>Full Build Including Digital Thermometer and STM MCU</figcaption> </figure>
            </div>
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/p8img3.png' alt=''/><figcaption>Operational Amplifier Design</figcaption> </figure>
                <figure><img src='/images/p8img4.png' alt=''/><figcaption>Circuit Diagram</figcaption> </figure>
