    ...
    return(
        ...
        <div className="banner">  
            ...
            <div className = "buttons">
                <Link to="/page1" id = 'button'><FiArrowLeft size = {20} color = 'black'/></Link>
                <Link to="/" id = 'button'><AiOutlineHome size = {20} color = 'black'/></Link>
                <Link to="/page3" id = 'button'><FiArrowRight size = {20} color = 'black'/></Link>
            </div>
        </div>
        <div className="ProjectContainer">
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/p2img1.png' alt=''/><figcaption>Final Setup + LEDs + Speaker</figcaption> </figure>
                <figure><img src='/images/p2img2.png' alt=''/><figcaption>Wiring Diagram</figcaption> </figure>
            </div>
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/p2img3.png' alt=''/><figcaption>Breadboard Wiring</figcaption> </figure>
            </div>
