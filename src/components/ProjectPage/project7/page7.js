    ...
    return(
        ...
        <div className="banner">  
            ...
            <div className = "buttons">
                ...
                <Link to="/page8" id = 'button'><FiArrowRight size = {20} color = 'black'/></Link>
            </div>
        </div>
        <div className="ProjectContainer">
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/p7img1.png' alt=''/><figcaption>Final Physical Circuit</figcaption> </figure>
                <figure><img src='/images/p7img2.png' alt=''/><figcaption>Full Build Including Stepper Motor and STM MCU</figcaption> </figure>
            </div>
            ...
            <div className='ProjectImageContainer'>
                <figure><img src='/images/p7img3.png' alt=''/><figcaption>H-Bridge Diagram</figcaption> </figure>
                <figure><img src='/images/p7img4.jpg' alt=''/><figcaption>Block Diagram</figcaption> </figure>
                <figure><img src='/images/p7img5.png' alt=''/><figcaption>Sample Code</figcaption> </figure>
